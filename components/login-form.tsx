...
export function LoginForm({
  ...
  const emailMessage = email && !emailValid ? { text: "Invalid Email", className: "text-destructive" } : null
      ...
      <FieldGroup>
        ...
        <Field>
          ...
          <FieldDescription className="text-center">
            ...
            <Link href={`/signup?returnTo=${encodeURIComponent(returnTo)}`} className="underline underline-offset-4">
              Sign up
            </Link>
          </FieldDescription>
        </Field>
