...
import { signUpWithEmail, signInWithEmail, signInWithGoogle, validatePassword, checkUsernameAvailable } from "@/lib/auth-actions"
import {
  Dialog,
  DialogContent,
  DialogDescription,
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" className="w-full" disabled={loading || (isSignUp && (checkingUsername || usernameAvailable === false))}>
