...
import { FantasyPosition } from "@/lib/types/ranking-schemas"
...
export function AddPlayerDrawer({
  ...
  const fetchPlayers = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/fantasy/players/search?${params}`)
      if (res.ok) {
  ...
  const handlePlayerClick = useCallback(
    ...
    [existingPlayerIds, onRemovePlayer, onAddPlayer]
  )
